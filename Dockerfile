...
FROM --platform=${JS_PLATFORM} node:24.1.0-alpine3.20 AS js-builder-base
...
COPY --from=distroless-prep ${GF_PATHS_PROVISIONING} ${GF_PATHS_PROVISIONING}
...
FROM alpine-base AS grafana-alpine
